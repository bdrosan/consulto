<x-app-layout>
    ...
    <div class="p-4 overflow-x-auto">
        ...
        <div class="w-full md:grid grid-cols-4 gap-4">
            <div class="col-span-3">
                <form action="{{ route('lead.bulkAction') }}" method="post">
                    ...
                    <div class="md:flex justify-between">
                        ...
                        <div class="mb-2">
                            <div class="flex">
                                <input type="text" name="q" id="search" form="search-form" placeholder="Search by name or phone" value="{{ $q ?? '' }}" class="w-72 py-1 px-4 bg-white border-gray-300 border-r-0 focus:border-gray-300 focus:ring-gray-200 focus:ring-opacity-50">
                                <button type="submit" form="search-form" class="px-4 bg-white border border-gray-300 border-l-0">
                    ...
                    @if($leads->count())
                    <x-auto-table th="Name,Phone,Country,Assigned To, Date Added" td="name,phone,country,assign_to,created_at" :data="$leads" link="lead" action checkbox />
                    @else
            ...
            <div class="col-span-1 bg-white mt-4 md:mt-0 overflow-y-auto max-h-screen">
