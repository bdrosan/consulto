<x-app-layout>
    <div class="mb-5">
        <a href="/lead/create" class="px-5 py-2 text-sm uppercase text-indigo-600 font-semibold tracking-widest outline-none border border-indigo-600 hover:text-white hover:bg-indigo-600 focus:border-purple-200 focus:outline-none active:border-transparent active:text-grey-900 transition-all">
    ...
    <div class="overflow-x-auto">
        ...
        <div class="w-full">
            <form action="{{ route('lead.bulkAction') }}" method="post">
                ...
                @if($leads->total()>0)
                <x-table th="Name,Phone,Country,Subject,Assigned To, Date Added" td="name,phone,country,subject,assign_to,created_at" :data="$leads" link="lead" action checkbox />
                @else
