    ...
    <div class="overflow-x-auto">
        ...
        <div class="w-ful">
            <form action="{{ route('lead.bulkAction') }}" method="post">
                    ...
                    <div class="mb-2">
                        <div class="flex">
                            <input type="text" name="q" id="search" form="search-form"
                                ...
                                class="w-72 py-1 px-4 bg-white border-gray-300 border-r-0 rounded-lg rounded-r-none focus:border-gray-300 focus:ring-gray-200 focus:ring-opacity-50">
                            <button type="submit" form="search-form"
                                class="px-4 bg-white border border-gray-300 border-l-0 rounded-lg rounded-l-none">
                ...
                @if($leads->total()>0)
                <x-auto-table th="Name,Phone,Country,Date Added" td="name,phone,country,created_at" :data="$leads"
                    link="../lead" action checkbox />
                @else
