<div class="md:h-screen hidden md:block bg-indigo-800 flex-shrink-0 w-56">
    <!-- Logo -->
    <a href="{{ route('dashboard') }}" class="flex-shrink-0 flex items-center p-5 text-white">
        <x-application-logo class="block h-10 w-auto fill-current" />
        <div class="ml-3 text-3xl">Consulto</div>
    </a>
    <div class="p-12 overflow-y-auto text-white">
        <div class="mb-4">
            <a href="{{ route('dashboard') }}" class="flex items-center group py-3">
                ...
                <div class="text-indigo-300 group-hover:text-white">{{ __('Dashboard') }}</div>
            </a>
        </div>
        <div class="mb-4">
            <a href="https://demo.inertiajs.com/organizations" class="flex items-center group py-3">
        ...
        <div class="mb-4">
            <a href="https://demo.inertiajs.com/contacts" class="flex items-center group py-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                    class="w-4 h-4 mr-2 fill-indigo-400 group-hover:fill-white">
                    <path
        ...
        <div class="mb-4">
            <a href="https://demo.inertiajs.com/reports" class="flex items-center group py-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                    class="w-4 h-4 mr-2 fill-indigo-400 group-hover:fill-white">
