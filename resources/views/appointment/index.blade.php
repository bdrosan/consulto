<x-app-layout>
    <div class="px-4 py-2 mb-4 bg-white">
        <a href="{{route('appointment.create')}}" class="text-sm uppercase hover:text-indigo-600 font-semibold tracking-widest outline-none focus:border-purple-200 focus:outline-none active:border-transparent active:text-grey-900 transition-all">
            ...
            <x-table>
                ...
                <x-tbody>
                    ...
                    <x-tr>
                        ...
                        <x-td-action allow="edit,delete" route="appointment" id="{{$appointment->id}}" />
                    </x-tr>
                    @endforeach
                </x-tbody>
            </x-table>
